...
<#macro script>
<script src="/static/app/js/project/index.js"></script>
</#macro>
<@detail/>
<#macro detail>
    ...
    <script id="saveModelTpl" type="text/html">
        <form id="saveForm">
            <div class="container-fluid">
                ...
                <br/>
                <div class="row">
                    <div class="col-md-12"><label>描述</label>
                ...
                <br/>
                <div class="row">
                    <div class="col-md-6"><label>负责人</label>
                        <input type="text" class="form-control" name="principal"
                               placeholder="负责人" value="{{ d.principal}}" required>
                    </div>
                    <div class="col-md-6"><label>联系电话</label>
                        <input type="text" class="form-control" name="phone"
                               placeholder="联系电话" value="{{ d.phone}}" required>
                    </div>
                </div>
                <br/>
                <div class="row">
                    <div class="col-md-6"><label>邮箱</label>
                        <input type="email" class="form-control" name="email"
                               placeholder="邮箱" value="{{ d.email}}" required>
                    </div>
                    <div class="col-md-6">
                        <label>可用</label>
                        <select class="form-control" name="enable">
